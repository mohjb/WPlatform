/*
todo:
codebase for including angularjs
create angular module, controllers
write for express
create restApi points
write sequilize for mariadb/test
create login screen
...
create main menu screen
	...
	list msgs
	profile-screen / edit
	list accounts/add account/ editAcc
	balance , balancePerAcc, transPerAcc
	buy/sell
	admin
		list users / search/filter
		edit user / approve new signup
		profile-screen / edit
		user trans
		accounts / balances
		new trans
		list banks / add bank/ edit
		list currencies / add/ edit
		msgs / newMsg
